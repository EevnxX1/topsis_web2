...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 23, 2024 at 09:17 AM
...
CREATE TABLE `login` (
  ...
  `password_asli` varchar(30) NOT NULL,
  `status` enum('admin','pemilik','user') NOT NULL
...
('Miftah', 'KacaMata', 'Kartini', '081222222', 'Miftah@example.com', '81dc9bdb52d04dc20036dbd8313ed055', '', 'user'),
('PUTRI', 'PUTRI', 'HHH', '0897865664566', 'superadmin@example.com', '81dc9bdb52d04dc20036dbd8313ed055', '', 'pemilik');
